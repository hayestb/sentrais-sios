...
export const DEFAULT_RACI_MATRIX: Record<string, {
  ...
  knox_phillips: {
    role: "CPO / CRO",
    email: "advisory@novatesolutions.ai",
  ...
  ai_platform_lead: {
    ...
    email: "governance@novatesolutions.ai",
  ...
  engagement_lead: {
    ...
    email: "success@novatesolutions.ai",
  ...
  solution_architect: {
    ...
    email: "architecture@novatesolutions.ai",
  ...
  metadata_partner: {
    ...
    email: "delivery@novatesolutions.ai",
